...
class DeviceDetector
  class OS < Parser
    ...
    OS_FAMILIES = {
      'Android' => %w[AND CYN FIR REM RZD MLD MCD YNS HAR],
      'AmigaOS' => %w[AMG MOR],
      ...
      'RISC OS' => %w[ROS],
      'GNU/Linux' => %w[
        LIN ARL DEB KNO MIN UBT KBT XBT LBT FED RHT VLN MDR GNT SAB SLW SSE CES BTR SAF ORD TOS
        RSO DEE FRE MAG FEN CAI PCL HAS LOS DVK
      ],
      'Mac' => %w[MAC],
